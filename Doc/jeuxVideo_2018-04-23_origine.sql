...
--
-- Client :  localhost
-- Généré le :  Lun 23 Avril 2018 à 09:46
...
(3, 'Test DLC', 'un DLC de test', 1),
(6, 'Test DLC2', 'un DLC de test', 1);
...
CREATE TABLE `Jeux` (
  ...
  `nom` varchar(100) NOT NULL,
  `Editeur_id` int(11) NOT NULL,
  `description` varchar(500) DEFAULT 'Non défini'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Jeux` (`id`, `nom`, `Editeur_id`, `description`) VALUES
(1, 'Mario kart', 1, 'Non défini'),
(2, 'Wii sport', 2, 'Non défini'),
(3, 'Endless ocean', 3, 'Non défini'),
(4, 'Sport Méca', 2, 'Non défini');
